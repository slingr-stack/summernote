...
(function () {
  ...
  var TooltipUI = /*#__PURE__*/function () {
    function TooltipUI($node, options) {
      ...
      this.$tooltip = $(['<div class="note-tooltip">', '<div class="note-tooltip-arrow"></div>', '<div class="note-tooltip-content"></div>', "</div>"].join(""));
    ...
    return _createClass(TooltipUI, [{
      key: "show",
      value: function show() {
        var $node = this.$node;
        var offset = $node.offset();
        var targetOffset = $(this.options.target).offset();
  ...
  var DropdownUI = /*#__PURE__*/function () {
    ...
    return _createClass(DropdownUI, [{
      key: "setEvent",
  ...
  var _button = renderer.create('<button type="button" class="note-btn" tabindex="-1"></button>', function ($node, options) {
  ...
  var dropdown = renderer.create('<div class="note-dropdown-menu" role="list"></div>', function ($node, options) {
    var markup = Array.isArray(options.items) ? options.items.map(function (item) {
      ...
      var $temp = $('<a class="note-dropdown-item" href="#" data-value="' + value2 + '" role="listitem" aria-label="' + value2 + '"></a>');
  ...
  var dropdownCheck = renderer.create('<div class="note-dropdown-menu note-check" role="list"></div>', function ($node, options) {
    var markup = Array.isArray(options.items) ? options.items.map(function (item) {
      var value2 = typeof item === "string" ? item : item.value || "";
      var content = options.template ? options.template(item) : item;
      var $temp = $('<a class="note-dropdown-item" href="#" data-value="' + value2 + '" role="listitem" aria-label="' + item + '"></a>');
  ...
  var ui = function ui(editorOptions) {
    return {
      ...
      button: function button(options) {
        return _button(_objectSpread(_objectSpread({}, options), {}, {
      ...
      check: function check($dom, value2) {
