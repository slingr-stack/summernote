...
(function () {
  ...
  var ni = /*#__PURE__*/function () {
    ...
    return _createClass(ni, [{
      ...
      value: function createVideoNode(t) {
        ...
        } else if (z || V || ki) L = $("<video controls>").attr("src", t).attr("width", "640").attr("height", "360");else if (yt && yt[0].length) L = $("<iframe>").attr("frameborder", 0).attr("src", "https://www.facebook.com/plugins/video.php?href=" + encodeURIComponent(yt[0]) + "&show_text=0&width=560").attr("width", "560").attr("height", "301").attr("scrolling", "no").attr("allowtransparency", "true");else return !1;
  ...
  var I = {
    ...
    xt = I.create('<div class="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"></div>'),
    ...
    ui = I.create('<div class="note-dropdown-menu dropdown-menu" role="list"></div>', function (i, t) {
    ...
    pi = I.create('<div class="note-dropdown-menu dropdown-menu note-check" role="list"></div>', function (i, t) {
      var e = Array.isArray(t.items) ? t.items.map(function (o) {
        var n = typeof o == "string" ? o : o.value || "",
          s = t.template ? t.template(o) : o;
    ...
    mi = I.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', function (i, t) {
      t.fade && i.addClass("fade"), i.attr({
        "aria-label": t.title
      }), i.html(['<div class="modal-dialog">', '<div class="modal-content">', t.title ? '<div class="modal-header"><h4 class="modal-title">' + t.title + '</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button></div>' : "", '<div class="modal-body">' + t.body + "</div>", t.footer ? '<div class="modal-footer">' + t.footer + "</div>" : "", "</div>", "</div>"].join(""));
    }),
    ...
    vi = function vi(i) {
      return {
        ...
        button: function button(t, e) {
          return I.create('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1"></button>', function (o, n) {
            n && n.tooltip && o.attr({
              title: n.tooltip,
        ...
        createLayout: function createLayout(t) {
          var e = (i.airMode ? ee([st([rt(), oe()])]) : i.toolbarPosition === "bottom" ? kt([st([rt(), xt()]), wt(), $t()]) : kt([wt(), st([rt(), xt()]), $t()])).render();
