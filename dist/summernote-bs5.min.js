...
(function () {
  ...
  var Rt = ["sans-serif", "serif", "monospace", "cursive", "fantasy"];
  function Nt(i) {
    return $.inArray(i.toLowerCase(), Rt) === -1 ? "'".concat(i, "'") : i;
  }
  function ce() {
    var i = "mw",
      t = "20px";
    ...
    function a(l, c) {
      s.clearRect(0, 0, 40, 20), s.font = t + " " + Nt(l) + ', "' + c + '"', s.fillText(i, 40 / 2, 20 / 2);
  ...
  function Fe(i, t) {
    return i.length ? Pt(i).reduce(function (o, n) {
      var s = ct(o);
  ...
  function De(i) {
    var t = [];
    for (var e = 0, o = i.length; e < o; e++) Lt(t, i[e]) || t.push(i[e]);
    return t;
  }
  function Me(i, t) {
    if (i && i.length && t) {
  ...
  var ut = E("TABLE"),
    Ft = E("DATA");
  function et(i) {
    return !mt(i) && !ft(i) && !Ve(i) && !q(i) && !ut(i) && !pt(i) && !Ft(i);
  }
  function ft(i) {
  ...
  function no(i, t) {
    return nt(i) && Ot(i.node, t);
  }
  function so(i, t) {
    return Z(i) && Ut(i.node, t);
  }
  function K(i) {
    var t = 0;
  ...
  function Vt(i) {
    if (i.nextSibling && i.parent === i.nextSibling.parent) return D(i.nextSibling) ? i.nextSibling : Vt(i.nextSibling);
  }
  function qt(i, t) {
  ...
  function vt(i, t) {
    ...
    if (D(i.node)) return i.node.splitText(i.offset);
    {
      ...
      return bt(l, a), e || (Mt(i.node), Mt(l)), n && (_(i.node) && X(i.node), _(l)) ? (X(l), i.node.nextSibling) : l;
    }
  }
  function _t(i, t, e) {
    ...
    return _createClass(R, [{
      ...
      value: function nativeRange() {
        if (S.isW3CRangeSupport) {
          ...
          return _t3.setEndPoint("EndToEnd", Xt({
            node: this.ec,
            offset: this.eo
          })), _t3;
        }
  ...
  var No = /*#__PURE__*/function () {
    function No(t) {
      ...
      this.bullet = new Qt(), this.options = t.options;
    }
    ...
    return _createClass(ni, [{
      ...
      value: function createVideoNode(t) {
        ...
        if (n && n[1].length === 11) {
          ...
          if (_typeof(n[2]) < "u") {
            var Et = n[2].match(o);
            if (Et) for (var ne = [3600, 60, 1], J = 0, xi = ne.length; J < xi; J++) Q += _typeof(Et[J + 1]) < "u" ? ne[J] * parseInt(Et[J + 1], 10) : 0;else Q = parseInt(n[2], 10);
          }
          L = $("<iframe>").attr("frameborder", 0).attr("src", "//www.youtube.com/embed/" + Tt + (Q > 0 ? "?start=" + Q : "")).attr("width", "640").attr("height", "360");
          ...
          var le = 0;
          m[6] !== "undefined" && (le = m[6]), L = $('<iframe allowfullscreen sandbox="allow-same-origin allow-scripts allow-popups">').attr("frameborder", 0).attr("src", "//" + m[1] + "/videos/embed/" + m[2] + "?loop=" + re + "&autoplay=" + ae + "&muted=" + le + (St > 0 ? "&start=" + St : "") + (se > 0 ? "&end=" + Q : "")).attr("width", "560").attr("height", "315");
        } else if (y && y[1].length || M && M[2].length) {
          var _Tt = y && y[1].length ? y[1] : M[2];
          L = $("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "310").attr("width", "500").attr("src", "https://v.qq.com/txp/iframe/player.html?vid=" + _Tt + "&amp;auto=0");
        } else if (z || V || ki) L = $("<video controls>").attr("src", t).attr("width", "640").attr("height", "360");else if ($t && $t[0].length) L = $("<iframe>").attr("frameborder", 0).attr("src", "https://www.facebook.com/plugins/video.php?href=" + encodeURIComponent($t[0]) + "&show_text=0&width=560").attr("width", "560").attr("height", "301").attr("scrolling", "no").attr("allowtransparency", "true");else return !1;
        ...
        if (!u.contains([w.code.ENTER, w.code.UP, w.code.DOWN], t.keyCode)) {
          ...
          if (this.hints.length && n) {
            ...
            s && (s.top -= a.top, s.left -= a.left, this.$popover.hide(), this.lastWordRange = o, this.hints.forEach(function (l, c) {
              ...
              left: s.left,
              top: s.top - this.$popover.outerHeight() - te
            }) : this.$popover.css({
              left: s.left,
              top: s.top + s.height + te
            }));
          } else this.hide();
        }
      }
  ...
  var I = {
    ...
    kt = I.create('<div class="note-editor note-frame card"></div>'),
    wt = I.create('<div class="note-toolbar card-header" role="toolbar"></div>'),
    st = I.create('<div class="note-editing-area"></div>'),
    rt = I.create('<textarea class="note-codable" aria-multiline="true"></textarea>'),
    xt = I.create('<div class="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>'),
    yt = I.create(['<output class="note-status-output" role="status" aria-live="polite"></output>', '<div class="note-statusbar" role="status">', '<div class="note-resizebar" aria-label="Resize">', '<div class="note-icon-bar"></div>', '<div class="note-icon-bar"></div>', '<div class="note-icon-bar"></div>', "</div>", "</div>"].join("")),
    ee = I.create('<div class="note-editor note-airframe"></div>'),
    oe = I.create(['<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>', '<output class="note-status-output" role="status" aria-live="polite"></output>'].join("")),
    di = I.create('<div class="note-btn-group btn-group">'),
    ui = I.create('<div class="note-dropdown-menu dropdown-menu" role="list">', function (i, t) {
      var e = Array.isArray(t.items) ? t.items.map(function (o) {
        ...
        return '<a class="dropdown-item" href="#" ' + (l + c) + ' role="listitem" aria-label="' + n + '">' + s + "</a>";
      }).join("") : t.items;
      i.html(e).attr({
        "aria-label": t.title
    ...
    pi = I.create('<div class="note-dropdown-menu dropdown-menu note-check" role="list">', function (i, t) {
      var e = Array.isArray(t.items) ? t.items.map(function (o) {
        var n = typeof o == "string" ? o : o.value || "",
          s = t.template ? t.template(o) : o;
        return '<a class="dropdown-item" href="#" data-value="' + n + '" role="listitem" aria-label="' + o + '">' + ie(t.checkClassName) + " " + s + "</a>";
      }).join("") : t.items;
      i.html(e).attr({
        "aria-label": t.title
      }), t && t.codeviewKeepButton && i.addClass("note-codeview-keep");
    ...
    mi = I.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', function (i, t) {
      t.fade && i.addClass("fade"), i.attr({
        "aria-label": t.title
      }), i.html(['<div class="modal-dialog">', '<div class="modal-content">', t.title ? '<div class="modal-header"><h4 class="modal-title">' + t.title + '</h4><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true"></button></div>' : "", '<div class="modal-body">' + t.body + "</div>", t.footer ? '<div class="modal-footer">' + t.footer + "</div>" : "", "</div>", "</div>"].join(""));
    }),
    gi = I.create(['<div class="note-popover popover bs-popover-auto show">', '<div class="popover-arrow"></div>', '<div class="popover-body note-popover-content note-children-container"></div>', "</div>"].join(""), function (i, t) {
      var e = _typeof(t.direction) < "u" ? t.direction : "bottom";
      i.attr("data-popper-placement", e), t.hideArrow && i.find(".popover-arrow").hide();
    }),
    bi = I.create('<div class="form-check"></div>', function (i, t) {
      i.html(['<label class="form-check-label"' + (t.id ? ' for="note-' + t.id + '"' : "") + ">", '<input type="checkbox" class="form-check-input"' + (t.id ? ' id="note-' + t.id + '"' : ""), t.checked ? " checked" : "", ' aria-label="' + (t.text ? t.text : "") + '"', ' aria-checked="' + (t.checked ? "true" : "false") + '"/>', " " + (t.text ? t.text : "") + "</label>"].join(""));
    }),
    ie = function ie(i, t) {
    ...
    vi = function vi(i) {
      return {
        ...
        button: function button(t, e) {
          return I.create('<button type="button" class="note-btn btn btn-outline-secondary btn-sm" tabindex="-1">', function (o, n) {
            n && n.data && n.data.toggle === "dropdown" ? (o.removeAttr("data-toggle"), o.attr("data-bs-toggle", "dropdown"), n && n.tooltip && o.attr({
              title: n.tooltip,
        ...
        createLayout: function createLayout(t) {
          var e = (i.airMode ? ee([st([rt(), oe()])]) : i.toolbarPosition === "bottom" ? kt([st([rt(), xt()]), wt(), yt()]) : kt([wt(), st([rt(), xt()]), yt()])).render();
